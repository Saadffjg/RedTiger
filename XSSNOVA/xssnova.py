...
try:
    ...
    try:
        ...
        if(ret_code != 0):
            ...
            quit()
        print ('%s fuzzywuzzy has been installed, restart XSSNOVA.' % info)
        quit()
except ImportError:  # throws error in python2
    print('%s XSSNOVA isn\'t compatible with python2.\n Use python > 3.4 to run XSSNOVA.' % bad)
    quit()
